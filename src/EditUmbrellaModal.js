...
export class EditUmbrellaModal extends Component{
    ...
    handleSubmit(event){
        ...
        fetch(process.env.REACT_APP_API+'umbrella',{
            ...
            body:JSON.stringify({
                UmbrellaId:event.target.UmbrellaId.value,
        ...
        <Row>
            <Col sm={6}>
                <Form onSubmit={this.handleSubmit}>
                    <Form.Group controlId="UmbrellaId">
                        <Form.Label>Id</Form.Label>
                        <Form.Control type="text" name="UmbrellaId" required
                        placeholder="UmbrellaId"
                        disabled
